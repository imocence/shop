...
<title>${message("member.couponCode.rechange")}[#if showPowered] - Powered By SHOP++[/#if]</title>
...
<body>
	[#assign current = "couponCodeRechange" /]
	...
	<div class="container member">
		<div class="row">
			...
			<div class="span10">
				<div class="list">
					<div class="title">${message("member.couponCode.rechange")}</div>
					<table class="list">
						<tr>
							<th>
