...
<title>${message("admin.warehouse.list")} - Powered By SHOP++</title>
...
<body>
	<div class="breadcrumb">
		${message("admin.warehouse.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
	...
	<input type="hidden" id="countryId" name="countryId" value="${countryId}" />
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if page.searchProperty == "name"] class="current"[/#if] val="name">${message("Warehouse.name")}</li>
				</ul>
			</div>
		</div>
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="name">${message("common.country")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="name">${message("Warehouse.name")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="icon">${message("Warehouse.code")}</a>
				</th>
				<th>
			...
			[#list page.content as warehouse]
				<tr>
					<td>
					...
					<td>
						<span title="${warehouse.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${warehouse.createdDate}</span>
					</td>
					<td>
						<a href="edit?id=${warehouse.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
