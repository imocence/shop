...
[#assign defaultSpecificationValueIds = defaultSku.specificationValueIds /]
                ...
                [#list product.specificationItems as specificationItem]
                    <dl class="clearfix">
                        ...
                        [#list specificationItem.entries as entry]
                            [#if entry.isSelected]
                                <dd>
                                    <a[#if defaultSpecificationValueIds[specificationItem_index] == entry.id]
                                            class="active"[/#if] href="javascript:;"
    ...
    [/#if]
        <div class="specification-footer">
            ...
            [#if product.type == "general"]
                <button id="addCart" class="btn btn-lg btn-primary btn-flat btn-block"
                        type="button">${message("shop.product.addCart")}</button>
            [#elseif product.type == "exchange"]
                <button id="exchange" class="btn btn-lg btn-primary btn-flat btn-block"
                ...
                <div id="summary" class="summary tab-pane active">
                    <div id="productImage" class="product-image carousel slide">
                        ...
                        [#list product.productImages as productImage]
                            <li[#if productImage_index == 0] class="active"[/#if] data-target="#productImage"
                                                             data-slide-to="${productImage_index}"></li>
                        [/#list]
                        </ol>
                    ...
                    <section>
                        ...
                        [#if product.caption?has_content]
                            <div class="orange" style="font-size: 12px">${product.caption}</div>
                        [/#if]
                        </h1>
                    </section>
                    <section>
                    ...
                    [#--[/#if]--]
                        ...
                        [/#if]
                        [#if setting.isShowMarketPrice]
                            <del style="font-size: 12px;color: #999999">${currency(product.marketPrice, true)}</del>
                        [/#if]
                        </strong>
                        <!-- 券  -->
	                    [#if currentUser == null]
