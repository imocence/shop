            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input id="username" name="username" class="form-control" type="text" maxlength="20"
                           placeholder="${message("member.login.usernameTitle")}">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input id="password" name="password" class="form-control" type="password" maxlength="20"
                           placeholder="${message("member.login.password")}" autocomplete="off">
                </div>
            </div>
...
[#if loginPlugins?has_content && !socialUserId?has_content && !uniqueId?has_content]
    [#list loginPlugins as loginPlugin]
        <a href="${base}/social_user_login?loginPluginId=${loginPlugin.id}"[#if loginPlugin.description??]
           title="${loginPlugin.description}"[/#if]>
