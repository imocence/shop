    ...
    public static Setting getSetting() {
        ...
        if (cacheElement == null) {
            ...
            try {
                ...
                List<org.dom4j.Element> elements = (List<org.dom4j.Element>) (List<?>) document.selectNodes("/shopxx/setting");
    ...
    public static List<TemplateConfig> getTemplateConfigs(TemplateConfig.Type type) {
        ...
        if (cacheElement == null) {
            ...
            try {
                File shopxxXmlFile = new ClassPathResource(CommonAttributes.SHOPXX_XML_PATH).getFile();
                Document document = new SAXReader().read(shopxxXmlFile);
                List<org.dom4j.Element> elements = (List<org.dom4j.Element>) (List<?>) document.selectNodes(type != null ? "/shopxx/templateConfig[@type='" + type + "']" : "/shopxx/templateConfig");
                for (org.dom4j.Element element : elements) {
