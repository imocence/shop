...
public interface ArticleCategoryService extends BaseService<ArticleCategory, Long> {
	 ...
	 * @return 顶级文章分类
	 */
	List<ArticleCategory> findRoots(Country  country);
	 ...
	 * @return 顶级文章分类
	 */
	List<ArticleCategory> findRoots(Integer count,Country  country);
	 ...
	 * @return 顶级文章分类
	 */
	List<ArticleCategory> findRoots(Integer count, boolean useCache,Country  country);
