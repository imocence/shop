...
public class Member extends User {
    ...
    public Set<FiBankbookBalance> getFiBankbookBalances() {
        if (fiBankbookBalances == null) {
            return new HashSet<>();
        }
        return new HashSet<>(fiBankbookBalances);
    }

    public void setFiBankbookBalances(Set<FiBankbookBalance> fiBankbookBalances) {
        // 避免设置同一个实例
        if (this.fiBankbookBalances == fiBankbookBalances) {
            return;
        }

        if (fiBankbookBalances == null) {
            this.fiBankbookBalances = new HashSet<>();
        } else {
            this.fiBankbookBalances = new HashSet<>(fiBankbookBalances);
        }
    }
